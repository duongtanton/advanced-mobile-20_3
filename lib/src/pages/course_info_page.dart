                ...
                RichText(
                    ...
                    text: const TextSpan(
                        ...
                        text:
                            ...
                            "If you have basic knowledge of English but have not "
                            "spent much time speaking, this course will help you ease"
                            " into your first English conversations.")),
                Padding(padding: EdgeInsets.only(top: 20)),
                Text(
                  "Bạn có thể làm gì",
                  style: TextStyle(fontSize: 16, fontWeight: FontWeight.w400),
                ...
                RichText(
                    ...
                    text: const TextSpan(
                        style: TextStyle(
                            color: Colors.black54, height: 1.5, fontSize: 14),
                        text:
                            "This course covers vocabulary at the CEFR A2 level. "
                            "You will build confidence while learning to speak about "
                            "a variety of common, everyday topics. In addition, you "
                            "will build implicit grammar knowledge as your tutor "
                            "models correct answers and corrects your mistakes.")),
