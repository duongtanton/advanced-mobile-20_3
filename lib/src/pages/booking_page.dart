...
import 'package:mobile_20120598/src/lang/booking.dart';
                    ...
                    onPressed: () {
                      (() async {
                        await bookingService
                            .book([schedule.id], bookingNote.text);
      ...
      if (tutor != null) {
        tutorWidgets = [
          ...
          ReadMoreText(
            ...
            trimCollapsedText: bookingLang[lang]!['readMore']!,
            trimExpandedText: bookingLang[lang]!['readLess']!,
            moreStyle:
                        ...
                        .map<Widget>(
                          (item) => Container(
                              ...
                              decoration: const BoxDecoration(
                                  ...
                                  color: Color.fromRGBO(221, 234, 254, 1)),
                              child: Text(
                                  CommonConstant.languageMap[item] ?? "",
                                  style: const TextStyle(color: Colors.blue))),
                        )
                        .toList()
                    : [],
          ...
          Column(
            ...
            children: [
              const Padding(padding: EdgeInsets.only(top: 20)),
              Text(
                bookingLang[lang]!['referenceCourse']!,
                style:
                    const TextStyle(fontSize: 18, fontWeight: FontWeight.w600),
              ),
              const Padding(padding: EdgeInsets.only(top: 10)),
          ...
          null != feedbacks && feedbacks?['count'] > 0
              ...
              : Text(bookingLang[lang]!['noEvaluation']!),
